...
public:
	...
	// インスタンスを複製する
	AppSettingPageIF* Clone() override { return new AppSettingPageRemote(); }

	DECLARE_APPSETTINGPAGE(AppSettingPageRemote)
private:
	struct PImpl;
