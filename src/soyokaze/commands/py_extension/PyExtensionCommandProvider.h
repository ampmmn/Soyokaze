...
class PyExtensionCommandProvider :
	public launcherapp::commands::common::UserCommandProviderBase
{
private:
	PyExtensionCommandProvider();
	~PyExtensionCommandProvider() override;
...
public:
	...
	DECLARE_LOADFROM(PyExtensionCommandProvider)


	DECLARE_COMMANDPROVIDER(PyExtensionCommandProvider)
