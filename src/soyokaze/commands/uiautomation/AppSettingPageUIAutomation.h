...
public:
	...
	// インスタンスを複製する
	AppSettingPageIF* Clone() override { return new AppSettingPageUIAutomation(); }

	DECLARE_APPSETTINGPAGE(AppSettingPageUIAutomation)
private:
	struct PImpl;
