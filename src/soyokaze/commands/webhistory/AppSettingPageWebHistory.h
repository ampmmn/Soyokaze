...
public:
	...
	// インスタンスを複製する
	AppSettingPageIF* Clone() override { return new AppSettingPageWebHistory(); }

	DECLARE_APPSETTINGPAGE(AppSettingPageWebHistory)
private:
	struct PImpl;
