...
public:
	...
	// インスタンスを複製する
	AppSettingPageIF* Clone() override { return new AppSettingPageVSCode(); }

	DECLARE_APPSETTINGPAGE(AppSettingPageVSCode)
private:
	struct PImpl;
