...
{
public:
	AppSettingExtraActionForExplorePath();
	~AppSettingExtraActionForExplorePath();
	...
	// インスタンスを複製する
	AppSettingPageIF* Clone() override { return new AppSettingExtraActionForExplorePath(); }

	DECLARE_APPSETTINGPAGE(AppSettingExtraActionForExplorePath)
private:
	struct PImpl;
