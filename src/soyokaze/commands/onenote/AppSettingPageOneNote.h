...
public:
	...
	// インスタンスを複製する
	AppSettingPageIF* Clone() override { return new AppSettingPageOneNote(); }

	DECLARE_APPSETTINGPAGE(AppSettingPageOneNote)
private:
	struct PImpl;
