...
{
public:
	Win32MenuAdhocCommand();
	Win32MenuAdhocCommand(const Win32MenuItemElement& elem, LPCTSTR prefix);
	virtual ~Win32MenuAdhocCommand();
...
// UnknownIF
	...
	DECLARE_ADHOCCOMMAND_UNKNOWNIF(Win32MenuAdhocCommand)
protected:
	struct PImpl;
