...
public:
	...
	// インスタンスを複製する
	AppSettingPageIF* Clone() override { return new AppSettingPageBookmark(); }

	DECLARE_APPSETTINGPAGE(AppSettingPageBookmark)
private:
	struct PImpl;
